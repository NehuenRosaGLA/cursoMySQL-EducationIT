...
CREATE TABLE `libreria`.`autores` (
  ...
  `telefono` VARCHAR(21) NULL,
  `direccion` VARCHAR(40) NULL,
  `ciudad` VARCHAR(20) NULL,
  `provincia` CHAR(2) NULL,
  `c_postal` CHAR(5) NULL,
...
-- agrego las primary keys faltantes 
...
CHANGE COLUMN `libro_id` `libro_id` VARCHAR(6) NOT NULL ,
DROP PRIMARY KEY,
